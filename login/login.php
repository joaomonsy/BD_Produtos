  ...
  <body>
    ...
    <div class="container">
      ...
      <form id="signup" method="post" name="signup">
        ...
        <button type="submit" name="btnconsultar2" id="cadastrar" >Cadastrar</button>
      </form>
      <div class="msg"></div>
      <div class="message">
        <?php
        ...
        if (isset($btnconsultar3))
        {
          ...
          foreach($pro_bd as $pro_mostrar)
          {
            if (count($pro_bd) > 0) {
              ...
              ?>
              <br><br><a href="../menu.html" class="btn-voltar">Entrar</a><br><br><br><br>
              <br><br>
              <?php
            }
          }
          if ($existe == false) {
            echo "<h3 class = 'mensagem'>Login inválido.</h3>";
          }
        }
